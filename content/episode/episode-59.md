...
-   11 CVEs addressed in Xenial
    -   [CVE-2017-16353](https://ubuntu.com/security/CVE-2017-16353) <!-- medium -->
    -   [CVE-2017-16352](https://ubuntu.com/security/CVE-2017-16352) <!-- medium -->
    -   [CVE-2017-15930](https://ubuntu.com/security/CVE-2017-15930) <!-- medium -->
    -   [CVE-2017-15277](https://ubuntu.com/security/CVE-2017-15277) <!-- medium -->
    -   [CVE-2017-14997](https://ubuntu.com/security/CVE-2017-14997) <!-- low -->
    -   [CVE-2017-14994](https://ubuntu.com/security/CVE-2017-14994) <!-- low -->
    -   [CVE-2017-14733](https://ubuntu.com/security/CVE-2017-14733) <!-- low -->
    -   [CVE-2017-14649](https://ubuntu.com/security/CVE-2017-14649) <!-- low -->
    -   [CVE-2017-14504](https://ubuntu.com/security/CVE-2017-14504) <!-- medium -->
    -   [CVE-2017-14314](https://ubuntu.com/security/CVE-2017-14314) <!-- medium -->
    -   [CVE-2017-14165](https://ubuntu.com/security/CVE-2017-14165) <!-- medium -->
...
-   1 CVEs addressed in Precise ESM, Trusty ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-17006](https://ubuntu.com/security/CVE-2019-17006) <!-- medium -->
...
-   8 CVEs addressed in Xenial, Bionic, Disco, Eoan
    ...
    -   [CVE-2019-17025](https://ubuntu.com/security/CVE-2019-17025) <!-- medium -->
    ...
    -   [CVE-2019-17020](https://ubuntu.com/security/CVE-2019-17020) <!-- medium -->
...
-   1 CVEs addressed in Trusty ESM
    -   [CVE-2019-10161](https://ubuntu.com/security/CVE-2019-10161) <!-- medium -->
...
-   1 CVEs addressed in Trusty ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-20372](https://ubuntu.com/security/CVE-2019-20372) <!-- medium -->
...
-   2 CVEs addressed in Precise ESM, Trusty ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-12420](https://ubuntu.com/security/CVE-2019-12420) <!-- medium -->
    -   [CVE-2018-11805](https://ubuntu.com/security/CVE-2018-11805) <!-- medium -->
-   DoS via excessive resource usage
-   RCE via crafted conf (CF) files - advised should only use trusted conf
    files


### [[USN-4238-1](https://usn.ubuntu.com/4238-1/)] SDL_image vulnerabilities [09:55] {#usn-4238-1-sdl-image-vulnerabilities-09-55}

-   12 CVEs addressed in Xenial, Bionic
    -   [CVE-2019-7635](https://ubuntu.com/security/CVE-2019-7635) <!-- medium -->
    -   [CVE-2019-5052](https://ubuntu.com/security/CVE-2019-5052) <!-- medium -->
    -   [CVE-2019-5051](https://ubuntu.com/security/CVE-2019-5051) <!-- medium -->
    -   [CVE-2019-13616](https://ubuntu.com/security/CVE-2019-13616) <!-- low -->
    -   [CVE-2019-12222](https://ubuntu.com/security/CVE-2019-12222) <!-- low -->
    -   [CVE-2019-12221](https://ubuntu.com/security/CVE-2019-12221) <!-- low -->
    -   [CVE-2019-12220](https://ubuntu.com/security/CVE-2019-12220) <!-- low -->
    -   [CVE-2019-12219](https://ubuntu.com/security/CVE-2019-12219) <!-- low -->
    -   [CVE-2019-12218](https://ubuntu.com/security/CVE-2019-12218) <!-- medium -->
    -   [CVE-2019-12217](https://ubuntu.com/security/CVE-2019-12217) <!-- low -->
    -   [CVE-2019-12216](https://ubuntu.com/security/CVE-2019-12216) <!-- medium -->
    -   [CVE-2018-3977](https://ubuntu.com/security/CVE-2018-3977) <!-- medium -->
...
-   4 CVEs addressed in Precise ESM, Trusty ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-11050](https://ubuntu.com/security/CVE-2019-11050) <!-- low -->
    -   [CVE-2019-11047](https://ubuntu.com/security/CVE-2019-11047) <!-- low -->
    -   [CVE-2019-11046](https://ubuntu.com/security/CVE-2019-11046) <!-- low -->
    -   [CVE-2019-11045](https://ubuntu.com/security/CVE-2019-11045) <!-- low -->
...
-   1 CVEs addressed in Xenial
    -   [CVE-2018-8828](https://ubuntu.com/security/CVE-2018-8828) <!-- high -->
...
-   2 CVEs addressed in Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-19725](https://ubuntu.com/security/CVE-2019-19725) <!-- medium -->
    -   [CVE-2019-16167](https://ubuntu.com/security/CVE-2019-16167) <!-- low -->
...
-   2 CVEs addressed in Precise ESM, Trusty ESM, Xenial, Bionic, Disco
    -   [CVE-2019-20367](https://ubuntu.com/security/CVE-2019-20367) <!-- medium -->
    -   [CVE-2016-2090](https://ubuntu.com/security/CVE-2016-2090) <!-- low -->
...
-   3 CVEs addressed in Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-19344](https://ubuntu.com/security/CVE-2019-19344) <!-- medium -->
    -   [CVE-2019-14907](https://ubuntu.com/security/CVE-2019-14907) <!-- low -->
    -   [CVE-2019-14902](https://ubuntu.com/security/CVE-2019-14902) <!-- low -->
...
-   1 CVEs addressed in Xenial, Bionic, Disco, Eoan
    -   [CVE-2020-5390](https://ubuntu.com/security/CVE-2020-5390) <!-- medium -->
