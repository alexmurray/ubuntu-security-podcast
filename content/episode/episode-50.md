...
lastmod = 2022-05-15T18:06:59+09:30
draft = false
weight = 1110
...
-   11 CVEs addressed in Precise ESM, Trusty ESM
    ...
    -   [CVE-2019-7578](https://ubuntu.com/security/CVE-2019-7578) <!-- low -->
    -   [CVE-2019-7577](https://ubuntu.com/security/CVE-2019-7577) <!-- low -->
    -   [CVE-2019-7576](https://ubuntu.com/security/CVE-2019-7576) <!-- low -->
    -   [CVE-2019-7575](https://ubuntu.com/security/CVE-2019-7575) <!-- low -->
    -   [CVE-2019-7574](https://ubuntu.com/security/CVE-2019-7574) <!-- low -->
    -   [CVE-2019-7573](https://ubuntu.com/security/CVE-2019-7573) <!-- low -->
    -   [CVE-2019-7572](https://ubuntu.com/security/CVE-2019-7572) <!-- low -->
...
-   1 CVEs addressed in Xenial, Bionic, Disco
    -   [CVE-2018-19518](https://ubuntu.com/security/CVE-2018-19518) <!-- medium -->
...
-   1 CVEs addressed in Eoan
    -   [CVE-2019-17544](https://ubuntu.com/security/CVE-2019-17544) <!-- medium -->
...
-   1 CVEs addressed in Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-17402](https://ubuntu.com/security/CVE-2019-17402) <!-- medium -->
-   OOB read -&gt; crash, DoS
...
-   3 CVEs addressed in Precise ESM, Trusty ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-18197](https://ubuntu.com/security/CVE-2019-18197) <!-- medium -->
    -   [CVE-2019-13118](https://ubuntu.com/security/CVE-2019-13118) <!-- low -->
    -   [CVE-2019-13117](https://ubuntu.com/security/CVE-2019-13117) <!-- low -->
...
-   9 CVEs addressed in Bionic (HWE) and Disco
    -   [CVE-2019-2181](https://ubuntu.com/security/CVE-2019-2181) <!-- medium -->
    -   [CVE-2019-16714](https://ubuntu.com/security/CVE-2019-16714) <!-- low -->
    -   [CVE-2019-15902](https://ubuntu.com/security/CVE-2019-15902) <!-- medium -->
    -   [CVE-2019-15505](https://ubuntu.com/security/CVE-2019-15505) <!-- low -->
    -   [CVE-2019-15504](https://ubuntu.com/security/CVE-2019-15504) <!-- low -->
    -   [CVE-2019-14821](https://ubuntu.com/security/CVE-2019-14821) <!-- medium -->
    -   [CVE-2019-14816](https://ubuntu.com/security/CVE-2019-14816) <!-- medium -->
    -   [CVE-2019-14815](https://ubuntu.com/security/CVE-2019-14815) <!-- medium -->
    -   [CVE-2019-14814](https://ubuntu.com/security/CVE-2019-14814) <!-- medium -->
...
-   1 CVEs addressed in Eoan
    -   [CVE-2019-18198](https://ubuntu.com/security/CVE-2019-18198) <!-- high -->
...
-   10 CVEs addressed in Trusty ESM (Azure), Xenial (HWE), Bionic
    -   [CVE-2019-15918](https://ubuntu.com/security/CVE-2019-15918) <!-- medium -->
    -   [CVE-2019-15902](https://ubuntu.com/security/CVE-2019-15902) <!-- medium -->
    -   [CVE-2019-15505](https://ubuntu.com/security/CVE-2019-15505) <!-- low -->
    ...
    -   [CVE-2019-14815](https://ubuntu.com/security/CVE-2019-14815) <!-- medium -->
    -   [CVE-2019-14814](https://ubuntu.com/security/CVE-2019-14814) <!-- medium -->
    -   [CVE-2018-21008](https://ubuntu.com/security/CVE-2018-21008) <!-- medium -->
...
-   10 CVEs addressed in Xenial and Trusty ESM (HWE)
    ...
    -   [CVE-2019-14814](https://ubuntu.com/security/CVE-2019-14814) <!-- medium -->
    -   [CVE-2018-21008](https://ubuntu.com/security/CVE-2018-21008) <!-- medium -->
    -   [CVE-2017-18232](https://ubuntu.com/security/CVE-2017-18232) <!-- medium -->
    -   [CVE-2016-10906](https://ubuntu.com/security/CVE-2016-10906) <!-- low -->
...
-   22 CVEs addressed in Bionic and Xenial + Xenial (HWE)
    ...
    -   [CVE-2019-12614](https://ubuntu.com/security/CVE-2019-12614) <!-- low -->
    -   [CVE-2019-11833](https://ubuntu.com/security/CVE-2019-11833) <!-- medium -->
    -   [CVE-2019-11478](https://ubuntu.com/security/CVE-2019-11478) <!-- high -->
    -   [CVE-2019-11477](https://ubuntu.com/security/CVE-2019-11477) <!-- high -->
    ...
    -   [CVE-2019-2181](https://ubuntu.com/security/CVE-2019-2181) <!-- medium -->
    -   [CVE-2019-2054](https://ubuntu.com/security/CVE-2019-2054) <!-- medium -->
...
-   2 high priority issues
    -   vhost_net issue from [Episode 47](https://ubuntusecuritypodcast.org/episode-47/)
