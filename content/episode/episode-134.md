...
-   1 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS)
    -   [CVE-2021-29425](https://ubuntu.com/security/CVE-2021-29425)
...
-   16 CVEs addressed in Focal (20.04 LTS)
    ...
    -   [CVE-2021-38203](https://ubuntu.com/security/CVE-2021-38203)
    -   [CVE-2021-38202](https://ubuntu.com/security/CVE-2021-38202)
...
-   1 CVEs addressed in Focal (20.04 LTS)
    -   [CVE-2020-12761](https://ubuntu.com/security/CVE-2020-12761)
...
-   1 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS), Hirsute (21.04)
    -   [CVE-2021-41103](https://ubuntu.com/security/CVE-2021-41103)
...
-   2 CVEs addressed in Bionic (18.04 LTS)
    -   [CVE-2018-17983](https://ubuntu.com/security/CVE-2018-17983)
...
-   3 CVEs addressed in Focal (20.04 LTS), Hirsute (21.04)
    -   [CVE-2021-3731](https://ubuntu.com/security/CVE-2021-3731)
    -   [CVE-2021-3694](https://ubuntu.com/security/CVE-2021-3694)
    -   [CVE-2021-3693](https://ubuntu.com/security/CVE-2021-3693)


### [[USN-5098-1](https://ubuntu.com/security/notices/USN-5098-1)] bl vulnerability {#usn-5098-1-bl-vulnerability}

-   1 CVEs addressed in Bionic (18.04 LTS)
    -   [CVE-2020-8244](https://ubuntu.com/security/CVE-2020-8244)
...
-   1 CVEs addressed in Xenial ESM (16.04 ESM), Bionic (18.04 LTS), Focal (20.04 LTS), Hirsute (21.04)
    -   [CVE-2021-41089](https://ubuntu.com/security/CVE-2021-41089)
...
-   1 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS), Hirsute (21.04)
    -   [CVE-2021-28116](https://ubuntu.com/security/CVE-2021-28116)


### [[USN-5105-1](https://ubuntu.com/security/notices/USN-5105-1)] Bottle vulnerability {#usn-5105-1-bottle-vulnerability}

-   1 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS)
    -   [CVE-2020-28473](https://ubuntu.com/security/CVE-2020-28473)
...
-   7 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS), Hirsute (21.04)
    ...
    -   [CVE-2021-38499](https://ubuntu.com/security/CVE-2021-38499)
...
-   1 CVEs addressed in Bionic (18.04 LTS), Focal (20.04 LTS)
    -   [CVE-2019-17455](https://ubuntu.com/security/CVE-2019-17455)
