...
-   1 CVEs addressed in Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-18874](https://ubuntu.com/security/CVE-2019-18874) <!-- medium -->
...
-   6 CVEs addressed in Precise ESM, Xenial, Bionic, Disco, Eoan
    -   [CVE-2019-5827](https://ubuntu.com/security/CVE-2019-5827) <!-- low -->
    -   [CVE-2019-5018](https://ubuntu.com/security/CVE-2019-5018) <!-- low -->
    -   [CVE-2019-19244](https://ubuntu.com/security/CVE-2019-19244) <!-- medium -->
    -   [CVE-2019-19242](https://ubuntu.com/security/CVE-2019-19242) <!-- low -->
    -   [CVE-2019-16168](https://ubuntu.com/security/CVE-2019-16168) <!-- low -->
...
-   12 CVEs addressed in Bionic (gcp-edge), Eoan (5.3 kernel)
    ...
    -   [CVE-2019-19069](https://ubuntu.com/security/CVE-2019-19069) <!-- medium -->
    ...
    -   [CVE-2019-18810](https://ubuntu.com/security/CVE-2019-18810) <!-- low -->
...
-   3 CVEs addressed in Bionic (HWE), Disco (5.0 kernel)
    -   [CVE-2019-19076](https://ubuntu.com/security/CVE-2019-19076) <!-- low -->
...
-   10 CVEs addressed in Xenial
    -   [CVE-2017-6335](https://ubuntu.com/security/CVE-2017-6335) <!-- low -->
    -   [CVE-2017-14042](https://ubuntu.com/security/CVE-2017-14042) <!-- medium -->
    -   [CVE-2017-13147](https://ubuntu.com/security/CVE-2017-13147) <!-- medium -->
    -   [CVE-2017-11637](https://ubuntu.com/security/CVE-2017-11637) <!-- medium -->
    -   [CVE-2017-11636](https://ubuntu.com/security/CVE-2017-11636) <!-- medium -->
    -   [CVE-2017-11403](https://ubuntu.com/security/CVE-2017-11403) <!-- medium -->
    -   [CVE-2017-11140](https://ubuntu.com/security/CVE-2017-11140) <!-- low -->
    -   [CVE-2017-11102](https://ubuntu.com/security/CVE-2017-11102) <!-- low -->
    -   [CVE-2017-10799](https://ubuntu.com/security/CVE-2017-10799) <!-- medium -->
    -   [CVE-2017-10794](https://ubuntu.com/security/CVE-2017-10794) <!-- medium -->
...
-   13 CVEs addressed in Bionic
    -   [CVE-2019-11506](https://ubuntu.com/security/CVE-2019-11506) <!-- medium -->
    -   [CVE-2019-11505](https://ubuntu.com/security/CVE-2019-11505) <!-- medium -->
    -   [CVE-2019-11474](https://ubuntu.com/security/CVE-2019-11474) <!-- low -->
    -   [CVE-2019-11473](https://ubuntu.com/security/CVE-2019-11473) <!-- low -->
    -   [CVE-2019-11010](https://ubuntu.com/security/CVE-2019-11010) <!-- medium -->
    -   [CVE-2019-11009](https://ubuntu.com/security/CVE-2019-11009) <!-- medium -->
    -   [CVE-2019-11008](https://ubuntu.com/security/CVE-2019-11008) <!-- medium -->
    -   [CVE-2019-11007](https://ubuntu.com/security/CVE-2019-11007) <!-- medium -->
    -   [CVE-2019-11006](https://ubuntu.com/security/CVE-2019-11006) <!-- medium -->
    -   [CVE-2019-11005](https://ubuntu.com/security/CVE-2019-11005) <!-- medium -->
    -   [CVE-2018-20189](https://ubuntu.com/security/CVE-2018-20189) <!-- medium -->
    -   [CVE-2018-20185](https://ubuntu.com/security/CVE-2018-20185) <!-- medium -->
