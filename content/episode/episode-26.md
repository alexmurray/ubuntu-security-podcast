...
description = """
  ...
  """
date = 2019-04-01
lastmod = 2022-05-15T18:07:17+09:30
draft = false
weight = 1134
...
-   2 CVEs addressed in Trusty, Xenial, Bionic, Cosmic
    -   [CVE-2019-9813](https://ubuntu.com/security/CVE-2019-9813)
    -   [CVE-2019-9810](https://ubuntu.com/security/CVE-2019-9810)
...
-   Both in the IonMonkey JIT compiler
    -   Incorrect alias information for the Array.prototype.slice method
        ...
        as a result
    -   Type confusion in handling of ,\__proto\_\_ mutations - ,\__proto\_\_ is
...
-   1 CVEs addressed in Trusty, Xenial, Bionic, Cosmic
    -   [CVE-2019-9628](https://ubuntu.com/security/CVE-2019-9628)
...
-   11 CVEs addressed in Trusty, Xenial, Bionic, Cosmic
    -   [CVE-2019-6778](https://ubuntu.com/security/CVE-2019-6778)
    -   [CVE-2019-3812](https://ubuntu.com/security/CVE-2019-3812)
    -   [CVE-2018-20216](https://ubuntu.com/security/CVE-2018-20216)
    -   [CVE-2018-20191](https://ubuntu.com/security/CVE-2018-20191)
    -   [CVE-2018-20126](https://ubuntu.com/security/CVE-2018-20126)
    -   [CVE-2018-20125](https://ubuntu.com/security/CVE-2018-20125)
    -   [CVE-2018-20124](https://ubuntu.com/security/CVE-2018-20124)
    -   [CVE-2018-20123](https://ubuntu.com/security/CVE-2018-20123)
    -   [CVE-2018-19489](https://ubuntu.com/security/CVE-2018-19489)
    -   [CVE-2018-16872](https://ubuntu.com/security/CVE-2018-16872)
    -   [CVE-2018-16867](https://ubuntu.com/security/CVE-2018-16867)
...
### [[USN-3924-1](https://usn.ubuntu.com/3924-1/)] mod_auth_mellon vulnerabilities {#usn-3924-1-mod-auth-mellon-vulnerabilities}

-   2 CVEs addressed in Bionic, Cosmic
    -   [CVE-2019-3878](https://ubuntu.com/security/CVE-2019-3878)
    -   [CVE-2019-3877](https://ubuntu.com/security/CVE-2019-3877)
...
-   1 CVEs addressed in Trusty, Xenial
    -   [CVE-2016-5684](https://ubuntu.com/security/CVE-2016-5684)
...
-   8 CVEs addressed in Xenial, Bionic, Cosmic
    -   [CVE-2018-7752](https://ubuntu.com/security/CVE-2018-7752)
    -   [CVE-2018-20763](https://ubuntu.com/security/CVE-2018-20763)
    -   [CVE-2018-20762](https://ubuntu.com/security/CVE-2018-20762)
    -   [CVE-2018-20761](https://ubuntu.com/security/CVE-2018-20761)
    -   [CVE-2018-20760](https://ubuntu.com/security/CVE-2018-20760)
    -   [CVE-2018-13006](https://ubuntu.com/security/CVE-2018-13006)
    -   [CVE-2018-13005](https://ubuntu.com/security/CVE-2018-13005)
    -   [CVE-2018-1000100](https://ubuntu.com/security/CVE-2018-1000100)
